 ...
 * \return Retorna 0 (EXITO) si obtuvo una cadena y -1 (ERROR) si no obtuvo
 *
 */
static int getString(char* cadena, int longitud)
{
...
//=======================================================================================
/**
 * \brief Verifica si la cadena ingresada si es flotante
 * \param pResultado Puntero al espacio de memoria donde se dejara el resultado de la funcion
 * \return Retorna 0 (EXITO) si se obtiene un  flotante y -1 (ERROR) si no obtiene
 *
 */
static int getFloat(float* pResultado)
{
 ...
 * \return Retorna 0 si  obtuvo el numero y -1 si no obtuvo
 *
 */
 ...
 * \return Retorna 1 (vardadero) si la cadena es flotante y 0 (falso) si no  es flotante
 *
 */
static int esFlotante(char* cadena)
{
 ...
 * \param mensajeError Es el mensaje de Error a ser mostrado
 * \param minimo Es el numero minimo a ser aceptado
 * \param maximo Es el maximo a ser aceptado
 *\param rintentos
